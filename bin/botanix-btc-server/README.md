...
This is likely because the file descriptor set is not being generated correctly. To re-generate delete src/rpc/btc_server.bin and make some arbitrary change to the source code and run `cd bin/botanix-btc-server && cargo build`.
