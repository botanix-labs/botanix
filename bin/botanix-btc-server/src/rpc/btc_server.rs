        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/btc_server.BtcServer/StartMigration" => {
                    ...
                    for StartMigrationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BtcServer>::start_migration(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/btc_server.BtcServer/EndMigration" => {
                    ...
                    for EndMigrationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BtcServer>::end_migration(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/btc_server.BtcServer/AbortMigration" => {
                    ...
                    impl<
                        T: BtcServer,
                    > tonic::server::UnaryService<super::AbortMigrationRequest>
                    for AbortMigrationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as BtcServer>::abort_migration(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
