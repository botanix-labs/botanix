...
mod tests {
    ...
    use reth_node_builder::NodeTypesWithDBAdapter;
    use reth_db::test_utils::{create_test_rw_db, create_test_static_files_dir, TempDatabase};
...
TransactionOrigin, TransactionPool,
    ...
    type ABCIClientType = ABCIClient<
        ...
        RethPool<
            TransactionValidationTaskExecutor<
                EthTransactionValidator<BlockchainProvider<BotanixNodeTypes>,
EthPooledTransaction>,             >,
    ...
    fn abci_client_builder() -> ABCIClientType {
        ...
        // setup db client
        let reth_db = Arc::new(
            Arc::try_unwrap(create_test_rw_db())
                .unwrap()
                .into_inner_db()
        );
        ...
        let reth_static_file_provider = StaticFileProvider::read_write(reth_static_path)
        ...
        let botanix_static_file_provider = StaticFileProvider::read_write(botanix_static_path)
        ...
        let bitcoind_client = Arc::new(FallbackBitcoindClient::default());
...
NonDeterministicData::deserialize(reader).expect("to deserialize");
    ...
    fn test_prepare_proposal_tx_in_mempool() {
        ...
        let mut tx_generator = TransactionGenerator::new(rand::rng());
