...
impl Transaction for BotanixTxEnv {
...
impl IntoTxEnv<Self> for BotanixTxEnv {
    fn into_tx_env(self) -> Self {
        self
    }
}

impl FromRecoveredTx<TransactionSigned> for BotanixTxEnv {
...
impl TransactionEnv for BotanixTxEnv {
...
impl SystemCallTx for BotanixTxEnv {
    fn new_system_tx_with_caller(
        ...
        let base = TxEnv::builder()
            ...
            .gas_limit(30_000_000) // Use Botanix's gas limit for system calls
            .build()
            .unwrap();
...
impl TryIntoTxEnv<BotanixTxEnv> for TransactionRequest {
...
mod tests {
    ...
    #[test]
    fn test_botanix_transaction_fields() {
        let botanix_tx = BotanixTxEnv {
            base: TxEnv {
                tx_type: 0,
                gas_limit: 10,
                gas_price: 100,
