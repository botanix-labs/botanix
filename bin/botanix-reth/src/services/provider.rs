...
pub fn create_blockchain_provider(
    ...
    BlockchainProvider<NodeTypesWithDBAdapter<BotanixNode,
    Arc<DatabaseEnv>>>, StaticFileProvider<BotanixPrimitives>,
    ...
    let static_files_provider = StaticFileProvider::read_write(reth_static_files_path)?;
