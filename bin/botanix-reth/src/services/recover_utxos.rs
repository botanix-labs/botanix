...
use botanix_btc_server_client::{BtcServerExtendedApi, BtcServerExtendedClient, RecoverMissingUtxosRequest};
...
pub async fn recover_missing_utxos(poa_cfg: &PoaNodeArgs, btc_server_client: &mut BtcServerExtendedClient) -> eyre::Result<()> {
