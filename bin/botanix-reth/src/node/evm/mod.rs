...
impl<DB, I> Evm for BotanixEvm<DB, I>
where
    DB: Database,
    I: Inspector<BotanixContext<DB>>,
{
    type DB = DB;
...
/// A regular botanix evm and executor builder.
#[derive(Debug, Default, Clone, Copy)]
#[non_exhaustive]
pub struct BotanixExecutorBuilder;

impl<Node> ExecutorBuilder<Node> for BotanixExecutorBuilder
where
