    ...
    R::Transaction: Into<TransactionSigned>,
{
    ...
    /// Applies system contract upgrades if the Jalapeno fork is not yet active.
    ...
    /// Initializes the Jalapeno contracts
    fn initialize_jalapeno_contracts(
        &mut self,
        beneficiary: Address,
        ...
        let txs = self.system_contracts.jalapeno_contracts_txs();
        for tx in txs {
