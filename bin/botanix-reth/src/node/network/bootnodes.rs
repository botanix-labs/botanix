...
/// Returns parsed Botanix mainnet bootnodes as a vector of NodeRecord.
pub fn botanix_mainnet_nodes() -> Vec<NodeRecord> {
    parse_nodes(BOTANIX_MAINNET_BOOTNODES)
}

/// Returns parsed botanix mainnet nodes
pub fn botanix_testnet_nodes() -> Vec<NodeRecord> {
    parse_nodes(BOTANIX_TESTNET_BOOTNODES)
}
...
/// Botanix mainnet boot nodes.
pub static BOTANIX_MAINNET_BOOTNODES: &[&str] = &[
...
/// Botanix testnet boot nodes.
pub static BOTANIX_TESTNET_BOOTNODES: &[&str] = &[
