...
pub mod mint_attack_contract {
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for MintAttackContract<M>
    {
    ...
    impl ::ethers::core::abi::AbiDecode for MintAttackContractCalls {
        ...
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError>
        {
            ...
            if let Ok(decoded) =
                <PassThroughBurnCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                )
            {
            ...
            if let Ok(decoded) =
                <PassThroughMintCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                )
            {
