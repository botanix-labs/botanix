...
pub mod multi_mint_helper_contract {
    ...
    pub static MULTIMINTHELPERCONTRACT_DEPLOYED_BYTECODE:
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for MultiMintHelperContract<M>
    {
    ...
    impl ::ethers::core::abi::AbiDecode for MultiMintHelperContractCalls {
        ...
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError>
        {
            ...
            if let Ok(decoded) =
                <MintingContractCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                )
            {
            ...
            if let Ok(decoded) =
                <MultiMintTwoCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                )
            {
    ...
    impl ::core::convert::From<MintingContractCall>
        for MultiMintHelperContractCalls
    {
