...
//                 Arc::clone(&chain),
//                 Arc::new(FallbackBitcoindClient::new(vec![BitcoindClientWrapper::Provider1(Arc::new(mock))], ClientSelection::Fallback)),
//             );
...
//             let mut syncer =
//                 BitcoinCheckpointsChainSynchronizer::new(chain, Arc::new(mock));
...
//             async fn is_synced(&self) -> Result<bool, botanix_btc_wallet::bitcoind::JsonRPCError>;
//             async fn wait_until_synced(&self);

//             fn get_best_block_hash_rpc(
//                 &self,
//             ) -> Result<bitcoin::BlockHash, botanix_btc_wallet::bitcoind::JsonRPCError>;
//             fn get_txids_rpc(
//                 &self,
//                 h: &bitcoin::BlockHash,
//             ) -> Result<Vec<bitcoin::Txid>, botanix_btc_wallet::bitcoind::JsonRPCError>;
//             fn get_estimate_smart_fee_rpc(
//                 &self,
//             ) -> Result<EstimateSmartFeeResult, botanix_btc_wallet::bitcoind::JsonRPCError>;
//             fn get_block_info_rpc(
//                 &self,
//                 block_hash: &bitcoin::BlockHash,
//             ) -> Result<GetBlockResult, botanix_btc_wallet::bitcoind::JsonRPCError>;
//         }
//     }
...
//         ) -> ::core::pin::Pin<
//             Box<
//                 dyn ::core::future::Future<Output = Result<bool, BitcoindError>>
//                     + ::core::marker::Send
//                     + 'async_trait,
//             >,
//         >
...
//         fn wait_until_synced<'life0, 'async_trait>(
//             &'life0 self,
//         ) -> ::core::pin::Pin<
//             Box<
